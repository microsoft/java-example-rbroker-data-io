    ...
    public RepoFileInRepoFileOut() {
        ...
        try {
            ...
            log.info("[  TASK OPTION   ] Repository storage request " +
                "set on task [ DiscreteTaskOptions.storageOptions ].");
        ...
        if(rTaskResult.isSuccess()) {
            ...
            try {
                ...
                if(jobIsSuccess) {
                    ...
                    /*
                     * Retrieve repository-managed stored file hip.csv
                     * generated by the background task.
                     */
                    RRepositoryFile repoFile =
                                    rUser.fetchFile("hip.csv",
                                                    "example-data-io",
                                                    "testuser", null);
                    List<RRepositoryFile> files = Arrays.asList(repoFile);
                    DeployRUtil.retrieveRepositoryFiles(files, log);
