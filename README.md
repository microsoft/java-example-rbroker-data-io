...
The following tutorials demonstrate how different types of data inputs and outputs can be sent to and retrieved from [DeployR-managed](https://msdn.microsoft.com/en-us/microsoft-r/deployr-about) R sessions when executing tasks using the [DeployR RBroker Framework](https://msdn.microsoft.com/en-us/microsoft-r/deployr-rbroker-framework).
...
1. [DeployR-encoded](https://msdn.microsoft.com/en-us/microsoft-r/deployr-api-reference#encode-r-object-data-for-use-on-the-api) application generated data, including data read from databases, data input by end-users, or data otherwise derived by your application logic. These data can be sent as inputs and automatically decoded into the workspace of an R session when executing R code or an R script.
...
1. [DeployR-encoded](https://msdn.microsoft.com/en-us/microsoft-r/deployr-api-reference#encode-r-object-data-for-use-on-the-api) R object workspace data (data.frame, list, primitive, etc) that were generated by the execution of R code or an R script.
...
For this, DeployR provides support for a feature called the External (Big Data) Directories. See [here](https://msdn.microsoft.com/en-us/microsoft-r/deployr-administrator-getting-started#big-data-policies) for details.
...
1. Log in as testuser into the [Repository Manager](https://msdn.microsoft.com/en-us/microsoft-r/deployr-repository-manager/deployr-repository-manager-about)
